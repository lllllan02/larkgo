...
// Internal 获取租户访问令牌
//
// - 飞书接口文档: https://open.feishu.cn/api-explorer/cli_a56d61eb303c100c?apiName=tenant_access_token_internal&from=op_doc_tab&project=auth&resource=auth&version=v3
